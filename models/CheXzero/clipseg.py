...
class CLIPDenseBase(nn.Module):
    ...
    def __init__(self, version, reduce_cond, reduce_dim, prompt, n_tokens):
        ...
        self.clip_model, _ = load_chexzero("/Users/vignavramesh/Documents/referring-img-seg-baseline/models/CheXzero/checkpoints/chexzero_weights/best_64_0.0001_original_16000_0.861.pt") #models/CheXzero/
    ...
    def rescaled_pos_emb(self, new_size):
        ...
        print(self.model.positional_embedding[1:].T.shape)
